...
matchfield.children[1].children[7].element.text = "Geno Mod v1";
...
function notificationOn() {
  ...
  notification.element.color = { r: 0.18823529411764706, g: 0.7568627450980392, b: 1, a: 0.5 };
  notification.children[0].element.enableMarkup = true;
  notification.children[0].element.text =
    '[color="#ffffff"]Geno Mod Loaded![/color]';
...
function notificationOff() {
  ...
  notification.element.color = { r: 0, g: 0, b: 0, a: 1 };
